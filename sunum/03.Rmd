...
Kuram, olguları tanımlayan; en az iki olgu arasında ilişki kuran; olgulara ilişkin tanımlar, varsayımlar, ilkeler ve genel önermeler (genellemeler) içeren bir yapıdır. 

- Bilimsel yöntemin bu aşamasında, tek tek gözlenen olaylardan, bu olayların tümünü olgusal olarak açıklayan ortak ve temel bir ilkeye ulaşma çabası vardır.

---
## Bilimsel Yöntem

- **Tümdengelim:** Birinci aşamada ortaya konan kuramın çıkarsamalarının oluşturulması
Bu aşamada, geliştirilen kurama göre, belirli koşullarda hangi durumlarla karşılaşılabileceğine dair tahminler (hipotezler) ortaya konur. Bu süreçte genelden özele, bütünden parçaya doğru ilerlenir.
