...
date: "2021-2022 GUZ-Hafta 5 <br> <br> <br> <br>`r emo::ji('e-mail')` katalay@hacettepe.edu.tr"
output:
...
- Bir araştırmada, amaçlardan bir bölümü hipotez, bir bölümü ise soru cümleleriyle ifade edilebilir. Ancak, aynı veriler için, soru cümlesi ve hipotez birlikte kullanılamaz. Soru cümleleri ve hipotezler, araştırmada toplanan verileri tanımlar nitelikte, işlevsel (fonksiyonel) olmalıdır. Her soru/hipotez yalnız bir tek ilişkiyi arayan ya da sınamak isteyen bir anlatıdır  (Karasar, 2000). 
...
- *Alternatif (Araştırma) Hipotezi* $H_1$ `r emo::ji('right')` İlişki var, Fark var
  ...
  - $H_1yönsüz$: İlişki var, Fark var
  
  - $H_1tekyönlü$:): İlişki ya da farkın hangi yönde olduğu hakkında bilgi içerir. 
